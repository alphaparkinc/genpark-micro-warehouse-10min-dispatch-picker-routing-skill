# genpark-micro-warehouse-10min-dispatch-picker-routing-skill
...
> **GenPark AI Agent Skill** -- 10-minute micro-warehouse darkstore order dispatch and picker routing (Zepto style)
